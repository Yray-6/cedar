  ...
  return (
    <div className="bg-primary pt-8 sm:pt-12 md:pt-16 pb-8 sm:pb-12">
      ...
      <div className="text-center mb-6 sm:mb-10 text-white px-4">
        <p className="text-goldss text-3xl sm:text-4xl md:text-5xl mb-2 sm:mb-3 font-bold">Our Service</p>
        <p className="text-base sm:text-lg font-semibold mb-2 sm:mb-4">CedarLinks Nigeria Limited</p>
